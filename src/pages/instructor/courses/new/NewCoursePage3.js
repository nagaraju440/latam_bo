    ...
    <div>
      <Form onSubmit={handleSubmit} schema={schema}>
        <div className="flex flex-col space-y-4 m-10 w-[400px]">
          <div className="font-normal">¿Esta asociado a una gira?</div>
          <SelectComponent
            name="mode"
          ...
          <div className="font-normal">¿Tiene un taller asociado?</div>
          ...
          <SelectComponent
            ...
            selectOptionsData={SelectBoxOptions}
          />
          <div className="font-normal"> ¿Quieres asociar un material de curso?</div>
          ...
          <SelectComponent
            ...
            selectOptionsData={SelectBoxOptions}
          />
          <div className="font-normal">¿Quieres asociar un seguimiento de 30 días?</div>
